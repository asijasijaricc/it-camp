...
// === Proverava jednakost tipa i vrednost dve strane:

console.log(5 === "5");
console.log(10 === 10);

// != Porverava razlicitos leve i desne strane:

console.log(5 != "5");
console.log(5 != 4);

// !== Proverava razlicitos tipa ili vrednosti leve i desene strane:
...
// ! logicko not => Vraca nam boolen. Koji ce da bude suprotne vrednosti od promenljive
console.log(!isSunny);
