// 1. Korisnik treba da unese 2 broja:
...
// 2. Preko switch naredbe:
// console.log(new Date().getDay);
// getDay() - daje vrednost 0-6
// switch(new Date().getDay())...
// Na osnovu vrednosti koju nam daje izraz iz switch naredbe, kroz caso_ve i eventualno default ispisati poruku:
// "Danas je 'radni dan'"
...
// Ispisati zbir broja deljivog sa 4 i broja 14  i+14 koji god da je deljis sa 14

//Ispisuj brojeve od 10-1
for (let i = 1; i >= 1; i--) {
  console.log(i);
}
