...
godine.forEach((godina) => {
  ...
  //   godina > 17 && punoletni.push(godina);
});

console.log(punoletni);

// filter() metoda pravi novi niz sa onim elementima koji su prosli test.
// Novi niz moze biti prazan, iste duzine kao i originalni ili imati manje elementa od originalnog niza.
// Zavisi od toga koliko je elemenata proslo test.
// callback funkcija vraca uslov koji neki element treba da zadovoljava kako bi prosao test (kako bib bio dodat novom nizu).

const godine3 = godine.filter((godina) => godina > 17);
console.log(godine3);

// 1.
// Prvi deo. Napraviti pomocni iz koji ce sadrzati elemente od oba niza.
...
// 2. Napraviti novi niz koji filtrira postojeci i vraca novi sa onim elementima starog niza, gde je drugo slovo e.
...
// callback funkcija reduce metode moze imati 4 arguemnta:
